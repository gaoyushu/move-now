...
export default class Mailbox extends Component {
    ...
    componentDidMount(){
        fetch('http://116.62.14.0:8666/news/exchange/'+localStorage.getItem('token'))
        ...
        fetch('http://116.62.14.0:8666/news/comment/'+localStorage.getItem('token'))
        .then(res =>{ return res.json() })
        .then(res =>{
             console.log(res);
             if(res.data!=='您没有评论消息！'){
        ...
        fetch('http://116.62.14.0:8666/news/good/'+localStorage.getItem('token'))
        .then(res =>{ return res.json() })
        .then(res =>{
             console.log(res); 
             if(res.data!=='您没有点赞消息！'){
        ...
        fetch('http://116.62.14.0:8666/news/myreq/'+localStorage.getItem('token'))
        .then(res =>{ return res.json() })
        .then(res =>{ 
            console.log(res); 
            this.setState({
