    ...
    render() {
        return (
            <div className='comment'>
                ...
                <Link to='/sentenceYou'><div style={{width:'10%',lineHeight:'45px',float:'left'}}> 
                ...
                <Link to='/select1'><button style={{marginTop:10,marginBottom:0,width:'100%',height:40,backgroundImage:'linear-gradient(to right, #8bcca1 , #57a099)',border:'0px',color:'#fff'}}>选择日记</button></Link>
