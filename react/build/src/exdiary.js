...
export default class Exdiary extends Component {
    constructor(){
      ...
      componentDidMount(){
        fetch('http://116.62.14.0:8666/changed/detail/1/'+this.props.location.state.shortdes_id)
    ...
    click1=()=>{
        for(var i=0;i<this.state.data.length;i++){
            ...
            if(this.state.data[i].isReply==false){
                
                this.setState({
                    aid:this.state.data[i].aid
                },()=>{
                    this.setState({
                    ...
                    body: JSON.stringify({ token:1,aid:`${this.state.aid}`,reply:`${this.state.reply}`})})
                    .then(res =>{ return res.json() })
                    .then(res=>{ 
                        console.log(res);
                        // console.log(this.state.reply); 
                ...
                <div className='comment'>
                    ...
                    ?   
                        ...
                        ?
                                ...
                                <div className='exdiary-div' style={{marginTop:10}}>
                                    <div className='exdiary-divt'>
                                    <div className='miss-touxiang' style={{marginRight:10}}>
                                        <img src='http://116.62.14.0:8666/api/image/5'/>
                                    </div>
                    ...
                    :    
                        ...
                        <div className='friend-div'>
                            <div className='exdiary-divt'>
                                <div className='exchange-touxiang' style={{float:"right",marginRight:15}}>
                                    <img src='http://116.62.14.0:8666/api/image/5'/>
                                </div>
